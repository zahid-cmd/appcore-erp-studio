...
@Component(
{
    selector:'activityAssignment-list',
...
export class ActivityAssignmentList
implements OnInit
{
    ...
    filteredActivityAssignments:
        ActivityAssignment[] =
    [];


    pagedActivityAssignments:
        ActivityAssignment[] =
    [];
        ...
        (
                ...
                number =>
            {
                const valueA:
                    any =
                    a[
                        event.field as keyof ActivityAssignment
                    ];
                ...
                this.activityassignmentservice
                    ...
                    ({
                        ...
                        ): void =>
                        {
                            console.error
                            (
                                'Delete Activity Assignment Error',
        ...
        void
    {
        ...
        (
            ...
            'Are you sure you want to restore the most recently deleted activity assignment?',
            ...
            ({
                ...
                (): void =>
                {
                    ...
                    (
                        ...
                        'The most recently deleted activity assignment has been restored.'
                    );
                ...
                ): void =>
                {
                    console.error
                    (
                        'Restore Activity Assignment Error',
                    ...
                    )
                    {
                        ...
                        (
                            ...
                            'There is no deleted activity assignment record to restore.'
                        );

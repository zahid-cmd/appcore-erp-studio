...
@Component(
{
    selector:'controlComponents-form',
    ...
    templateUrl:'./control-components-form.html',


    styleUrls:
    [
        './control-components-form.css'
    ]
})


export class ControlComponentsForm
implements OnInit
{
    ...
    private readonly componentDirectory =
        'Frontend_Studio\\Studio_UI\\src\\shared\\components\\controls';
        ...
        void
    {
        ...
        this.controlcomponentsservice
            ...
            .subscribe(
            {
                ...
                {
                    console.error(
                        'Generate Control Components Code Error',
                        error
                    );
                ...
                error:(error) =>
                {
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            error,
                            'Failed to load Control Components.'
                        )
                    );
                ...
                .subscribe(
                {
                    next:() =>
                    {
                        ...
                        this.toast.success(
                            ...
                            'Control Components created successfully.'
                        );
                    ...
                    {
                        console.error(
                            'Create Control Components Error',
                            error
                        );
                        ...
                        this.toast.error(
                            ...
                            this.getErrorMessage(
                                error,
                                'Failed to create Control Components.'
                            )
                        );
                    }
                });
            ...
            .subscribe(
            {
                next:() =>
                {
                    ...
                    this.toast.success(
                        ...
                        'Control Components updated successfully.'
                    );
                ...
                {
                    console.error(
                        'Update Control Components Error',
                        error
                    );
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            error,
                            'Failed to update Control Components.'
                        )
                    );
                }
            });

...
@Component(
{
    selector:'utilityComponents-form',
    ...
    templateUrl:'./utility-components-form.html',


    styleUrls:
    [
        './utility-components-form.css'
    ]
})


export class UtilityComponentsForm
implements OnInit
{
    ...
    private readonly componentDirectory =
        'Frontend_Studio\\Studio_UI\\src\\shared\\components\\utilities';
        ...
        void
    {
        ...
        this.utilitycomponentsservice
            ...
            .subscribe(
            {
                ...
                {
                    console.error(
                        'Generate Utility Components Code Error',
                        error
                    );
                ...
                error:(error) =>
                {
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            error,
                            'Failed to load Utility Components.'
                        )
                    );
                ...
                .subscribe(
                {
                    next:() =>
                    {
                        ...
                        this.toast.success(
                            ...
                            'Utility Components created successfully.'
                        );
                    ...
                    {
                        console.error(
                            'Create Utility Components Error',
                            error
                        );
                        ...
                        this.toast.error(
                            ...
                            this.getErrorMessage(
                                error,
                                'Failed to create Utility Components.'
                            )
                        );
                    }
                });
            ...
            .subscribe(
            {
                next:() =>
                {
                    ...
                    this.toast.success(
                        ...
                        'Utility Components updated successfully.'
                    );
                ...
                {
                    console.error(
                        'Update Utility Components Error',
                        error
                    );
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            error,
                            'Failed to update Utility Components.'
                        )
                    );
                }
            });

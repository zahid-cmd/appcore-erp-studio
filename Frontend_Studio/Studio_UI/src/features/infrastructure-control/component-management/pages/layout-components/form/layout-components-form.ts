...
@Component(
{
    selector:'layoutComponents-form',
    ...
    templateUrl:'./layout-components-form.html',


    styleUrls:
    [
        './layout-components-form.css'
    ]
})


export class LayoutComponentsForm
implements OnInit
{
    ...
    private readonly componentDirectory =
        'Frontend_Studio\\Studio_UI\\src\\shared\\components\\layout';
        ...
        void
    {
        ...
        this.layoutcomponentsservice
            ...
            .subscribe(
            {
                ...
                {
                    console.error(
                        'Generate Layout Components Code Error',
                        error
                    );
                ...
                error:(error) =>
                {
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            error,
                            'Failed to load Layout Components.'
                        )
                    );
        ...
        void
    {
                ...
                .subscribe(
                {
                    next:() =>
                    {
                        ...
                        this.toast.success(
                            ...
                            'Layout Components created successfully.'
                        );
                    ...
                    {
                        console.error(
                            'Create Layout Components Error',
                            error
                        );
                        ...
                        this.toast.error(
                            ...
                            this.getErrorMessage(
                                error,
                                'Failed to create Layout Components.'
                            )
                        );
                    }
                });
        ...
        this.layoutcomponentsservice
            ...
            .subscribe(
            {
                ...
                {
                    console.error(
                        'Update Layout Components Error',
                        error
                    );
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            error,
                            'Failed to update Layout Components.'
                        )
                    );
                }
            });

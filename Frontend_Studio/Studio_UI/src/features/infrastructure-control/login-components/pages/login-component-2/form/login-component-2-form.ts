...
import
{
    ...
    CreateLoginComponent2,

    UpdateLoginComponent2,

    LoginComponent2Defaults
}
...
@Component(
{
    ...
    templateUrl:'./login-component-2-form.html',


    styleUrls:
    [
        './login-component-2-form.css'
    ]
})


//===============================================================
// Login Component 2 Form Component
//===============================================================

export class LoginComponent2Form
implements OnInit
{
        ...
        void
    {
        ...
        this.logincomponent2service
            ...
            .subscribe(
            {
                ...
                {
                    console.error(
                        'Generate Login Component 2 Defaults Error',
                    ...
                    void =>
                {
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            ...
                            'Failed to load Login Component 2.'
                        )
                    );
                ...
                .subscribe(
                {
                    ...
                    (): void =>
                    {
                        ...
                        this.toast.success(
                            ...
                            'Login Component 2 created successfully.'
                        );
                    ...
                    {
                        console.error(
                            'Create Login Component 2 Error',
                        ...
                        this.toast.error(
                            ...
                            this.getErrorMessage(
                                ...
                                'Failed to create Login Component 2.'
                            )
                        );
                    }
                });
            ...
            .subscribe(
            {
                ...
                (): void =>
                {
                    ...
                    this.toast.success(
                        ...
                        'Login Component 2 updated successfully.'
                    );
                ...
                {
                    console.error(
                        'Update Login Component 2 Error',
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            ...
                            'Failed to update Login Component 2.'
                        )
                    );
                }
            });

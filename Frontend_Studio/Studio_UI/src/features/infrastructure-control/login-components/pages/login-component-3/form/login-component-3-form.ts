...
@Component(
{
    ...
    templateUrl:'./login-component-3-form.html',


    styleUrls:
    [
        './login-component-3-form.css'
    ]
})


//===============================================================
// Login Component 3 Form Component
//===============================================================

export class LoginComponent3Form
implements OnInit
{
        ...
        void
    {
        ...
        this.logincomponent3service
            ...
            .subscribe(
            {
                ...
                {
                    console.error(
                        'Generate Login Component 3 Defaults Error',
                    ...
                    void =>
                {
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            ...
                            'Failed to load Login Component 3.'
                        )
                    );
                ...
                .subscribe(
                {
                    ...
                    (): void =>
                    {
                        ...
                        this.toast.success(
                            ...
                            'Login Component 3 created successfully.'
                        );
                    ...
                    {
                        console.error(
                            'Create Login Component 3 Error',
                        ...
                        this.toast.error(
                            ...
                            this.getErrorMessage(
                                ...
                                'Failed to create Login Component 3.'
                            )
                        );
                    }
                });
            ...
            .subscribe(
            {
                ...
                (): void =>
                {
                    ...
                    this.toast.success(
                        ...
                        'Login Component 3 updated successfully.'
                    );
                ...
                {
                    console.error(
                        'Update Login Component 3 Error',
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            ...
                            'Failed to update Login Component 3.'
                        )
                    );
                }
            });

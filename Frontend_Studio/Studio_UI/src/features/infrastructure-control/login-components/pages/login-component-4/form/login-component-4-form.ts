...
import
{
    ...
    CreateLoginComponent4,

    UpdateLoginComponent4,

    LoginComponent4Defaults
}
...
@Component(
{
    ...
    templateUrl:'./login-component-4-form.html',


    styleUrls:
    [
        './login-component-4-form.css'
    ]
})


//===============================================================
// Login Component 4 Form Component
//===============================================================

export class LoginComponent4Form
implements OnInit
{
        ...
        void
    {
        ...
        this.logincomponent4service
            ...
            .subscribe(
            {
                ...
                {
                    console.error(
                        'Generate Login Component 4 Defaults Error',
                    ...
                    void =>
                {
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            ...
                            'Failed to load Login Component 4.'
                        )
                    );
                ...
                .subscribe(
                {
                    ...
                    (): void =>
                    {
                        ...
                        this.toast.success(
                            ...
                            'Login Component 4 created successfully.'
                        );
                    ...
                    {
                        console.error(
                            'Create Login Component 4 Error',
                        ...
                        this.toast.error(
                            ...
                            this.getErrorMessage(
                                ...
                                'Failed to create Login Component 4.'
                            )
                        );
                    }
                });
            ...
            .subscribe(
            {
                ...
                (): void =>
                {
                    ...
                    this.toast.success(
                        ...
                        'Login Component 4 updated successfully.'
                    );
                ...
                {
                    console.error(
                        'Update Login Component 4 Error',
                    ...
                    this.toast.error(
                        ...
                        this.getErrorMessage(
                            ...
                            'Failed to update Login Component 4.'
                        )
                    );
                }
            });

...
@Component(
{
    ...
    templateUrl:'./login-component-2-list.html',

    styleUrl:'./login-component-2-list.css'
})
...
implements OnInit
{
    ...
    filteredLoginComponent2s:
        LoginComponent2[] =
    [];


    pagedLoginComponent2s:
        LoginComponent2[] =
    [];
        ...
        this.logincomponent2service
            ...
            ({
                ...
                ): void =>
                {
                    ...
                    this.filteredLoginComponent2s =
                    [];


                    this.pagedLoginComponent2s =
                    [];
                    ...
                    (
                        ...
                        'Unable to load logincomponent2s.'
                    );
        ...
        void
    {
        ...
        this.filteredLoginComponent2s.sort
        (
            (
                a:
                    LoginComponent2,
                ...
                number =>
            {
                const valueA:
                    any =
                    a[
                        event.field as keyof LoginComponent2
                    ];
                    ...
                    ({
                        ...
                        ): void =>
                        {
                            ...
                            (
                                ...
                                'Failed to delete loginComponent2.'
                            );
                        }
                    });
            }
        ...
        void
    {
        ...
        (
            ...
            'Are you sure you want to restore the most recently deleted loginComponent2?',
            ...
            ({
                ...
                (): void =>
                {
                    ...
                    (
                        ...
                        'The most recently deleted loginComponent2 has been restored.'
                    );
                ...
                ): void =>
                {
                    ...
                    (
                        ...
                        'Failed to restore loginComponent2.'
                    );
                }
            });
    }
            ...
            ({
                ...
                ): void =>
                {
                    ...
                    (
                        ...
                        'Failed to load loginComponent2 history.'
                    );
                }
            });
    }

...
//===============================================================
// LoginComponent3Controller
//===============================================================

[ApiController]

[Route("api/infrastructure-control/login-components/login-component-3")]

public class LoginComponent3Controller
    : ControllerBase
{
    //===========================================================
    // Repository
    ...
    private readonly ILoginComponent3Repository _repository;
    ...
    public LoginComponent3Controller
    (
        ILoginComponent3Repository repository
    )
    {
        _repository =
            repository;

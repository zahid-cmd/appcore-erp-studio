...
[Route("api/infrastructure-control/code-management/server-management")]
    ...
    : ControllerBase
{
    ...
    private readonly IServerManagementRepository _repository;
    ...
    (
        IServerManagementRepository repository
    )
    {
        _repository =
            repository;

...
//===============================================================
// LoginComponent2Controller
//===============================================================

[ApiController]

[Route("api/infrastructure-control/login-components/login-component-2")]

public class LoginComponent2Controller
    : ControllerBase
{
    //===========================================================
    // Repository
    ...
    private readonly ILoginComponent2Repository _repository;
    ...
    public LoginComponent2Controller
    (
        ILoginComponent2Repository repository
    )
    {
        _repository =
            repository;

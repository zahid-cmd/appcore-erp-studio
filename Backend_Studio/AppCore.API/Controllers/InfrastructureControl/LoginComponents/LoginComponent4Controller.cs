...
//===============================================================
// LoginComponent4Controller
//===============================================================

[ApiController]

[Route("api/infrastructure-control/login-components/login-component-4")]

public class LoginComponent4Controller
    : ControllerBase
{
    //===========================================================
    // Repository
    ...
    private readonly ILoginComponent4Repository _repository;
    ...
    public LoginComponent4Controller
    (
        ILoginComponent4Repository repository
    )
    {
        _repository =
            repository;

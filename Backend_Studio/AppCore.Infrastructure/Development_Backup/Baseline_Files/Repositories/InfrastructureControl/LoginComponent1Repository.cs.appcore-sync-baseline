    ...
    : ILoginComponent1Repository
{
    ...
    public async Task<IReadOnlyList<global::AppCore.Domain.Entities.InfrastructureControl.LoginComponents.LoginComponent1>>
        GetAllAsync()
    {
        return await _context
            .Set<global::AppCore.Domain.Entities.InfrastructureControl.LoginComponents.LoginComponent1>()
            .AsNoTracking()
            .Where(
                x =>
                    !x.IsDeleted
    ...
    public async Task<global::AppCore.Domain.Entities.InfrastructureControl.LoginComponents.LoginComponent1?>
        GetByIdAsync
    (
        long id
    )

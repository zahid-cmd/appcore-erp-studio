...
//=============================================================== 
// LoginComponent3Configuration 
//=============================================================== 
 
public class LoginComponent3Configuration 
    : IEntityTypeConfiguration<LoginComponent3> 
{ 
    ...
    ( 
        EntityTypeBuilder<LoginComponent3> builder 
    ) 
    { 

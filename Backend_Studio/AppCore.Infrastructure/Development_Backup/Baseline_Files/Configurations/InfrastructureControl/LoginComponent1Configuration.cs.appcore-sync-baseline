...
//=============================================================== 
// LoginComponent1Configuration 
//=============================================================== 
 
public class LoginComponent1Configuration 
    : IEntityTypeConfiguration<LoginComponent1> 
{ 
    ...
    ( 
        EntityTypeBuilder<LoginComponent1> builder 
    ) 
    { 

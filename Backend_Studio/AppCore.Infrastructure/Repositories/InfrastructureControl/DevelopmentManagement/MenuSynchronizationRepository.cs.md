    ...
    : IMenuSynchronizationRepository
{
    ...
    )
    {
        ...
        //=======================================================
        //
        // A Menu may only be synchronized after its parent
        // Module Synchronization has successfully completed.
        //
        ...
        //=======================================================
        // Parent Module Not Synchronized
        //=======================================================
        ...
        )
        {
            ...
            (
                $"Menu synchronization is blocked because the parent Module '{synchronization.ModuleName}' has not been successfully synchronized."
            );
        }
    ...
    )
    {
        ...
        //=======================================================
        // Check Dependent Submenu Synchronization
        //=======================================================
        //
        // IMPORTANT:
        //
        // A Submenu configuration that is only:
        //
        //     Created
        //     Saved
        //     Analyzed
        ...
        //     Pending
        //
        // MUST NOT block Menu rollback.
        //
        // Only an actually synchronized Submenu blocks the
        // rollback of its parent Menu.
        //
        //=======================================================

        var synchronizedSubmenuExists =
        ...
        )
        {
            return new MenuSynchronizationRollbackValidationDto
            {
                ...
                Message =
                    $"Menu rollback is blocked because one or more Submenu Synchronizations under '{synchronization.MenuName}' have already been successfully synchronized."
            };
        }
    ...
    )
    {
        ...
        //=======================================================
        //
        // This is the authoritative backend protection.
        //
        // Even if the frontend validation is bypassed, a
        // synchronized Submenu must still prevent Menu rollback.
        //
        //=======================================================

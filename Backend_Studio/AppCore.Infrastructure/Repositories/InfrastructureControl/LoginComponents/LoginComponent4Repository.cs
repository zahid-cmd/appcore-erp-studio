...
public class LoginComponent4Repository
    : ILoginComponent4Repository
{
    ...
    public LoginComponent4Repository
    (
    ...
    public async Task<IReadOnlyList<LoginComponent4>>
        GetAllAsync()
    {
    ...
    public async Task<LoginComponent4?>
        GetByIdAsync
    (
        long id
    )
    ...
    )
    {
        ...
        _context.ActivityHistories.Add(
            new ActivityHistory
            {
                ...
                ActivityTitle =
                    "LoginComponent4 Created",

                ActivityDescription =
                    $"LoginComponent4 '{entity.Name}' was created.",
    ...
    )
    {
        ...
        {
            throw new DirectoryNotFoundException(
                $"Deleted LoginComponent4 backup was not found for Id '{entity.Id}'."
            );
        }
    ...
    )
    {
        ...
        {
            throw new InvalidOperationException(
                "LoginComponent4 record was not found."
            );
        }
        ...
        _context.ActivityHistories.Add(
            new ActivityHistory
            {
                ...
                ActivityTitle =
                    "LoginComponent4 Updated",

                ActivityDescription =
                    $"LoginComponent4 '{existing.Name}' was updated.",
    ...
    )
    {
        ...
        _context.ActivityHistories.Add(
            new ActivityHistory
            {
                ...
                ActivityTitle =
                    "LoginComponent4 Deleted",

                ActivityDescription =
                    $"LoginComponent4 '{entity.Name}' was deleted.",
        ...
        RestoreAsync()
    {
        ...
        {
            throw new InvalidOperationException(
                "No deleted LoginComponent4 record was found to restore."
            );
        }
        ...
        _context.ActivityHistories.Add(
            new ActivityHistory
            {
                ...
                ActivityTitle =
                    "LoginComponent4 Restored",

                ActivityDescription =
                    $"LoginComponent4 '{entity.Name}' was restored.",

    ...
    : ILoginComponent3Repository
{
    ...
    public async Task<IReadOnlyList<LoginComponent3>>
        GetAllAsync()
    {
    ...
    public async Task<LoginComponent3?>
        GetByIdAsync
    (
        long id
    )
    ...
    )
    {
        ...
        {
            throw new DirectoryNotFoundException(
                $"Deleted LoginComponent3 backup was not found for Id '{entity.Id}'."
            );
        }
        ...
        RestoreAsync()
    {
        ...
        {
            throw new InvalidOperationException(
                "No deleted LoginComponent3 record was found to restore."
            );
        }

    ...
    : ILoginComponent2Repository
{
    ...
    public async Task<IReadOnlyList<LoginComponent2>>
        GetAllAsync()
    {
    ...
    public async Task<LoginComponent2?>
        GetByIdAsync
    (
        long id
    )
    ...
    )
    {
        ...
        {
            throw new DirectoryNotFoundException(
                $"Deleted LoginComponent2 backup was not found for Id '{entity.Id}'."
            );
        }
        ...
        RestoreAsync()
    {
        ...
        {
            throw new InvalidOperationException(
                "No deleted LoginComponent2 record was found to restore."
            );
        }
